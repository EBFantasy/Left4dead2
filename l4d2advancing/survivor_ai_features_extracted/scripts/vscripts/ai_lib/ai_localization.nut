...
function I18n::init() {
	local english =  {
		...
		ping_lead = "Navigate",
		ping_scout = "Scout 30s",
		ping_medical = "Medical",
		ping_medical_kit = "First Aid Kit",
		ping_medical_pills = "Pain Pills",
		ping_medical_adrenaline = "Adrenaline",
		ping_medical_back = "Back",
		ping_medical_cancel = "Cancel",
		ping_manual_use = "Device"
	};
	...
	local schinese =  {
		...
		ping_scout = "探路 30秒",
		ping_medical = "医疗",
		ping_medical_kit = "医疗包",
		ping_medical_pills = "止痛药",
		ping_medical_adrenaline = "肾上腺素",
		ping_medical_back = "返回",
		ping_medical_cancel = "取消",
		ping_manual_use = "机关"
	};
	...
	local tchinese =  {
		...
		ping_scout = "探路 30秒",
		ping_medical = "醫療",
		ping_medical_kit = "醫療包",
		ping_medical_pills = "止痛藥",
		ping_medical_adrenaline = "腎上腺素",
		ping_medical_back = "返回",
		ping_medical_cancel = "取消",
		ping_manual_use = "機關"
	};
